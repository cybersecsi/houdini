            ...
            <footer className="text-white body-font bg-gray-900 py-8">
                <div className="container lg:max-w-5xl px-5 py-8 mx-auto flex items-center md:flex-row flex-col">
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a className="ml-3 text-gray-500" href="https://twitter.com/cybersecsi" target="_blank" rel="noopener noreferrer">
                            <svg className="w-5 h-5 fill-gray-500 hover:fill-white transition-colors duration-300" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                            </svg>
                        </a>

                        <a className="ml-3 text-gray-500" href="https://github.com/cybersecsi" target="_blank" rel="noopener noreferrer">
                            <svg className="w-5 h-5 fill-gray-500 hover:fill-white transition-colors duration-300" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
